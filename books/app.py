...
def nuevoLibro():
    if request.method == 'POST':
        nuevoLibro = Libro(titulo=request.form['nombre'],autor=request.form['autor'],genero=request.form['genero'])
        session.add(nuevoLibro) #Agrego los cambios/datos agregados en la linea anterior
